            ...
            <div class="card mb-0" [style]="'background-color:'+bgColor +'!important'">
                <div class="flex flex-row-reverse justify-between mb-4">
                    <div class="flex flex-col justify-between">
                        <span class="block  font-medium mb-4 text-white  text-xl" [style]="'color:'+textColor" >{{label || ''}}</span>
                        <div class=" dark:text-surface-0 font-medium text-4xl  text-center " [style]="'color:'+textColor" >{{value || '-'}}</div>
                    </div>
